...
LAST_ACTION = 0
# The background image was generated by ChatGPT with GPT-5 and the prompt
# "Can you create a pixel art arctic background for my video game?"
BG_IMAGE = pygame.image.load("assets/background.png").convert()
BG_IMAGE = pygame.transform.scale(BG_IMAGE, (SCREEN_WIDTH, SCREEN_HEIGHT))

# The ice block image was generated by ChatGPT with GPT-5 and the prompt
# "On the theme of arctic images, can you create a tall slim pixel ice block for the player to avoid?"
ICE_BLOCK = pygame.image.load("assets/iceblock.png").convert_alpha()

# Stars from https://www.freepik.com/free-vector/hand-drawn-video-game-element_40128290.htm
